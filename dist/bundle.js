...
module.exports = '<ul class="ui fluid list">\n  <li class="item" v-repeat="items" v-class="closed: state == \'closed\'">\n    <div class="content">\n      <div class="header">\n<!--         <i class="checkbox icon"\n          v-class="checked: state == \'closed\', empty: state == \'open\'"></i> -->\n        <img class="closedcheckicon" v-show="state == \'closed\'" src="http://icons.iconarchive.com/icons/visualpharm/icons8-metro-style/512/Very-Basic-Checked-checkbox-icon.png" width="16px" height="16px">\n        <img class="opencheckicon" v-show="state == \'open\'" src="http://icons.iconarchive.com/icons/visualpharm/icons8-metro-style/512/Very-Basic-Unchecked-checkbox-icon.png" width="16px" height="16px">\n        <a href="{{html_url}}" target="_blank">\n        {{title}}\n        </a>\n        <span class="finished" v-show="state == \'closed\'">Complete!</span>\n        <span class="inprogress" v-show="state == \'open\'">In progress...</span>\n        <!-- <small class="muted">{{project}}/#{{number}}</small> -->\n        <!-- <div v-repeat="labels" class="ui circular label" v-style="background: \'#\' + color" v-attr="title: name"></div> -->\n         <div class="content" v-class="active: accordionOpen">\n          <div v-if="body" v-html="body | stripComments | marked"></div>\n          <div v-if="!body">\n            <em>No description provided.</em>\n          </div>\n         </div>\n      </div>\n    </div>\n  </li>\n</ul>\n';
